package ru.suleymanovtat.diffutil;
...
public class DummyEmployeeDataUtils {
    ...
    public static List<Employee> getEmployeeSortedByName() {
        final List<Employee> employeeList = getNewList();
    ...
    private static List<Employee> getNewList() {
        final List<Employee> employees = new ArrayList<>();
        employees.add(new Employee(1, "Employee 1", "Developer"));
        employees.add(new Employee(2, "Employee 2", "Tester"));
        employees.add(new Employee(3, "Employee 3", "Support"));
        ...
        employees.add(new Employee(20, "Employee 20", "Tester"));
        employees.add(new Employee(30, "Employee 30", "Support"));
        return employees;
    }
